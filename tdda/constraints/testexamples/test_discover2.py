...
"""
test_discover2.py: Automatically generated test code from tdda gentest.
...
COMMAND = 'tdda discover INPUTS/testdata/accounts25k.csv output/accounts25k.tdda'
CWD = os.path.abspath(os.path.dirname(__file__))
REFDIR = os.path.join(CWD, 'ref', 'discover2')
...
class TestAnalysis(ReferenceTestCase):
    ...
    def test_accounts25k_tdda(self):
        ...
        self.assertFileCorrect(os.path.join(CWD, 'output/accounts25k.tdda'),
